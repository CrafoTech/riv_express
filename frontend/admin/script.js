...
let analytics_drop_down_icon = document.querySelector('.analytics_drop_down_icon');
let notification_drop_down_icon = document.querySelector('.notification_drop_down_icon');

let dashboard_window = document.querySelector('.dashboard-window');
let analytics_window_assets = document.querySelector('.analytics-window-assets');
let analytics_window_riders = document.querySelector('.analytics-window-riders');
let analytics_window_collections = document.querySelector('.analytics-window-collections');
let notifications_window_general = document.querySelector('.notifications-window-general');
let notifications_window_personal = document.querySelector('.notifications-window-personal');
...
function notification_personal_btn() {
    manageMainWindow(notifications_window_personal,"Notifications"," - Personal")
...
const collectionFilterDiv_on_Pop = document.getElementById('collectionFilterDiv_on_Pop');
...
const personalNotificationSortDiv = document.getElementById('personalNotificationSortDiv');
const generalNotificationFilterDiv = document.getElementById('generalNotificationFilterDiv');
...
const asset_collections_card = document.querySelector('.asset_collections_card')
...
// const  view_rider_pop = document.querySelector('.view_rider_pop')
const  send_general_notification_pop = document.querySelector('.send_general_notification_pop')
const  send_persona_notification_pop = document.querySelector('.send_persona_notification_pop')
const  search_for_rider_to_send_noti = document.querySelector('#search_for_rider_to_send_noti')

let general_noti_type_txt = document.getElementById('general_noti_type_txt')
let general_noti_subject_txt = document.getElementById('general_noti_subject_txt')
let general_noti_message_txt = document.getElementById('general_noti_message_txt')
...
let asset_todays_amount_txt = document.getElementById('asset_todays_amount_txt');
let asset_amount_recieved_txt = document.getElementById('asset_amount_recieved_txt');
...
const add_asset_distributor_txt = document.getElementById('add_asset_distributor_txt');
...
async function getDashBoardDataFunc() {
    ...
    try {
        ...
        const rider_res = await fetch(`${baseUrl}/getall/${dbname}/${'rider_data'}`);
...
function displayAssetDataFunc() {
    ...
    allAssetsDataArr.forEach( (asset,i) => {
        ...
        // console.log(asset)
         ...
         Asset_Rider_Amount_Expected = asset.collections[asset.collections.length - 1].amount_expected;
         Asset_Rider_Amount_Recieved = asset.collections[asset.collections.length - 1].amount_recieved;
         Asset_Rider_Balance_Due = asset.collections[asset.collections.length - 1].balance_due;
         Asset_Rider_Wallet = asset.collections[asset.collections.length - 1].wallet;
         Asset_Rider_Payment_Date = asset.collections[asset.collections.length - 1].cdate;
...
function editAssetFunc(index) {
    ...
    try {
        ...
        console.log("Editing: ",asset.asset_id," Recieved: ",asset.collections[n-1].amount_recieved)
    ...
    try {
        ...
        console.log(`Res2: `, await data2)
            ...
            case 'collection':
                ...
                let Expected_Amount = Number(asset.collections[n-1].amount_expected)
                ...
                let Wallet = Amount_Recieved>Expected_Amount ? (Current_Wallet + (Amount_Recieved - Expected_Amount)) : 0
...
async function deleteAssetFunc(index) {
    ...
    try {
        loading_animation_div.style.display = 'flex'
        const res = await fetch(`${baseUrl}/deleteoneasset_id/${dbname}/${cname}/${asset_id}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'Application/json'
            }
...
function viewRidertFunc(index) {
    ...
    let Rider_emp_date = rider.emp_date;
...
async function saveEditRiderFunc(index) {
    ...
    try {
        loading_animation_div.style.display = 'flex'
        const res = await fetch(`${baseUrl}/updateone_rider_rider_id/${dbname}/${cname}/${riderId}`, {
            method: "PATCH",
            headers: {
                'Content-Type': 'Application/json'
            },
...
async function deleteRiderFunc(index) {
    ...
    try {
        loading_animation_div.style.display = 'flex'
        const res = await fetch(`${baseUrl}/deleteone_rider_rider_id/${dbname}/${cname}/${riderId}`, {
            method: "DELETE",
            headers: {
                'Content-Type': 'Application/json'
            }
...
let collection_viewed_rider_id_select_inp = document.getElementById('collection_viewed_rider_id_select_inp')
...
let collection_payment_infomation_parent = document.querySelector('.collection_payment_infomation_parent')
...
function displayassetCollectionsDataFun() {
    ...
    allAssetsDataArr.forEach( (asset,i) => {
        ...
        // allAssetDataCollections = asset.collections
         ...
         Asset_State = asset.asset_state
         Asset_Rider = asset.rider.rname;
         Asset_Rider_Collection_Money = asset.collections[asset.collections.length - 1].cmoney;
         Asset_Rider_Amount_Expected = asset.collections[asset.collections.length - 1].amount_expected;
         Asset_Rider_Amount_Recieved = asset.collections[asset.collections.length - 1].amount_recieved;
         Asset_Rider_Balance_Due = asset.collections[asset.collections.length - 1].balance_due;
         Asset_Rider_Wallet = asset.collections[asset.collections.length - 1].wallet;
...
collection_viewed_rider_id_select_inp.addEventListener('change', () => {
    collection_viewed_rider_id_select = collection_viewed_rider_id_select_inp.value
    viewCollectionFunc(collections_asset_index_Flag)
...
let all_general_notications_cards = document.querySelector('.all_general_notications_cards');
let all_personal_notications_cards = document.querySelector('.all_personal_notications_cards');
...
async function updategeneralNotificationFunc(index) {
    ...
    try {
        ...
        const res = await fetch(`${baseUrl}/updateonedoc_id/${dbname}/${cname}/${noti_id}`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'Application/json'
            },
...
async function deletegeneralNotificationFunc(index) {
    ...
    try {
        loading_animation_div.style.display = 'flex'
        const res = await fetch(`${baseUrl}/deleteonedoc_id/${dbname}/${cname}/${noti_id}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'Application/json'
            }
